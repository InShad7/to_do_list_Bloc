...
class EditTime extends StatelessWidget {
  var passValue;
   ...
   EditTime({super.key,required this.passValue});
  ...
  Widget build(BuildContext context) {
    ...
    final hours = passValue.date.hour.toString().padLeft(2, '0');
    final minutes = passValue.date.hour.toString().padLeft(2, '0');
  ...
  Future<TimeOfDay?> pickTime(context) => showTimePicker(
        context: context,
        initialTime: TimeOfDay.fromDateTime(passValue.date),
      );
  }
